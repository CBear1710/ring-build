...
import {
  ...
  copyToClipboard,
  openCenteredPopup,
} from "@/lib/ring-configurator/share-util";
...
export function ShareActions() {
  ...
  const font = useConfigStore(
    (s: any) => (s.engravingFont ?? "regular").toLowerCase()
  );
  ...
  return (
    <div className="flex gap-5 md:gap-2">
      ...
      >
        <span className="pointer-events-none [&_svg]:h-9 [&_svg]:w-9 [&_circle]:stroke-0 [&_rect]:stroke-0">
          <CopyLinkIcon />
        </span>
      </button>
